...
theme.tasklist_fg_focus                         = "#d65d0e"
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            pl(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, "#b16286"),
            pl(wibox.widget { cpuicon, cpu.widget, layout = wibox.layout.align.horizontal }, "#458588"),
            pl(wibox.widget { tempicon, temp.widget, layout = wibox.layout.align.horizontal }, "#689d6a"),
            --pl(wibox.widget { fsicon, theme.fs and theme.fs.widget, layout = wibox.layout.align.horizontal }, "#CB755B"),
            pl(wibox.widget { baticon, bat.widget, layout = wibox.layout.align.horizontal }, "#98971a"),
            pl(wibox.widget { neticon, net.widget, layout = wibox.layout.align.horizontal }, "#d79921"),
            pl(wibox.widget.textclock(" %d.%m %H:%M ",60), "#d65d0e"),
            --]]
            --[[ using separators
